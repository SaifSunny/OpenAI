export const surpriseMePrompts = [
  'Generate a realistic portrait of a fictional character',
  'Create an abstract landscape using vibrant colors',
  'Produce a futuristic cityscape with flying cars',
  'Generate a realistic depiction of a historic monument',
  'Create an otherworldly creature that could exist in a fantasy world',
  'Produce a photorealistic still life of a fruit basket',
  'Generate a whimsical illustration of a fairy tale scene',
  'Create a minimalist design of a famous landmark',
  'Produce an animated GIF of a cute animal doing a silly dance',
  'Generate a surrealistic image that plays with perspective',
  'Create a collage of different textures and patterns',
  'Produce a retro-style illustration of a sci-fi scene',
  'Generate an impressionistic landscape of a famous city',
  'Create a minimalist design of a famous person',
  'Produce an animated GIF of a city skyline at night',
  'Generate a realistic depiction of a fictional vehicle',
  'Create a pop art-style portrait of a celebrity',
  'Produce an abstract design that represents a feeling or emotion',
  'Generate a surrealistic image that combines different elements',
  'Create a digital painting of a nature scene',
